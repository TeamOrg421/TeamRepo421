            ...
            {filteredItems.map(item => (
              ...
              >
                <div className="watchlist-card-img-wrap">
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill={item.isWatched ? '#ef4444' : 'none'} stroke={item.isWatched ? '#ef4444' : 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
